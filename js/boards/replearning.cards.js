  ...
  "foundation": {
    ...
    "cards": [
      ...
      },
      {
        ...
        "expanded": false,
        "body": "<table class=\"comp-table\"><tr><th></th><th>线性</th><th>非线性</th></tr><tr><td>公式</td><td><span class=\"code-inline\">Z = WX + b</span></td><td><span class=\"code-inline\">Z = σ(WX + b)</span></td></tr><tr><td>表示空间</td><td>线性子空间（超平面）</td><td>弯曲流形</td></tr><tr><td>捕获的统计量</td><td>二阶（协方差）</td><td>高阶、非欧</td></tr><tr><td>训练方式</td><td>有闭式解（SVD / 矩阵分解）</td><td>需要梯度下降（BP + SGD）</td></tr><tr><td>最优解</td><td>保证全局最优</td><td>不保证（可能陷入局部最优）</td></tr><tr><td>堆叠多层</td><td>等价于一层（线性闭包）</td><td>产生层次抽象</td></tr><tr><td>代表方法</td><td>PCA, SVD, NMF, ICA, LDA</td><td>Deep AE, VAE, SimCLR, ViT</td></tr></table>\n<p>从形式上看，差距确实就一个激活函数——但这个\"差距\"打开了一整个新世界。</p>"
      }
    ]
  }
};
